...
kg/WKeditor/2.0.0/plugin/WKfont/WKfont
kg/WKeditor/2.0.0/index

*/
KISSY.add('kg/WKeditor/2.0.0/plugin/WKfont/WKfont',function (S, Node,XTemplate) {
    var EMPTY = '';
    var $ = Node.all;
    /**
     * 
...
KISSY.add('kg/WKeditor/2.0.0/index',function (S, Node,XTemplate,WKfont) {
    var EMPTY = '';
    var $ = Node.all;
    /**
     * @class WKeditor
